  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="Hybrid cloud solutions with AWS for better agility and cost control. Connect on-prem and cloud seamlessly." />
        <meta name="keywords" content="Hybrid cloud solutions, AWS, on-prem and cloud, seamless connectivity, agility, cost control" />
          <link rel="canonical" href="https://globalxperts.net/solutions/cloud/aws-hybrid-cloud" />
