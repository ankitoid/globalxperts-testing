...
const CloudSolutions = () => {
  return (
    <>
      <Navbar />
      <Helmet>
        <title> AWS Cloud Migration​ & Managed Services in USA - GlobalXperts </title>
        <meta name="description" content="GlobalXperts delivers expert AWS solutions - design, migrate and manage your AWS environment from Raleigh, NC to businesses across the USA for secure, scalable growth. " />
        <meta name="keywords" content="AWS cloud solutions, AWS migration, AWS security, AWS data solutions, AWS AI/ML solutions, AWS hybrid cloud implementation" />
