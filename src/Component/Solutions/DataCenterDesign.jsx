...
function DataCenterDesign() {
  ...
  const faqs = [
    ...
    embedUrl: "https://www.globalxperts.net/solutions/data-center-design", // Match your website structure
  };

  return (
    <>
    <Helmet>
        <title>Data Center Design/Build - GlobalXperts</title>
        <meta name="description" content="GlobalXperts offers data-centre design solutions - plan, build and optimize resilient, efficient infrastructure to support your enterprise operations across the USA."/>
         <meta name="keywords" content="Database, data, mysql,IT support"/>
         <script type="application/ld+json">
          {JSON.stringify(DataCenterJsonLD)}
        </script>
          <link rel="canonical" href="https://globalxperts.net/solutions/data-center-design" />
