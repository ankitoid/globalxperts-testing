  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="GlobalXperts’ Smart Transit solutions empower mobility networks—real-time data, connected systems & scalable infrastructure for modern transit operations."/>
      ...
      <div className="max-w-7xl mx-auto  py-4 space-y-8 bg-gray-100 text-gray-900 p-2">
          ...
          <div className="space-y-12 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="w-full h-full rounded-2xl overflow-hidden shadow-xl">
                ...
                >
                  {["Subway_outside.png", "traffic2.jpg", "traffic3.jpg"].map(
                    (img, i) => (
                      <SwiperSlide key={i}>
                        <img
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="w-full h-full rounded-2xl overflow-hidden shadow-xl">
                <Swiper
                  ...
                  className="w-full h-full"
                >
                  {["Model_cars.png", "Traffic_intelligence.png"].map(
                    (img, i) => (
                      <SwiperSlide key={i}>
                        <img
                          src={`https://main-website-images1.s3.ap-south-1.amazonaws.com/solutions/smart-transit/${img}`}
              ...
              <div className="flex justify-center">
                <div className="bg-white shadow-xl p-8 rounded-2xl w-full max-w-xl transition-shadow hover:shadow-2xl duration-300 flex flex-col justify-between md:min-h-[380px]">
                    ...
                    <ul className="text-gray-600 list-disc list-inside text-base space-y-3 text-left">
                      <li>
                        For Smart Transit, we can install and manage IoT
                        sensors, and we can help you collect, analyze, and
                        interpret data from these sensors to optimize
                        operations, improve efficiency, and drive business
                        decisions.
                      </li>
                      <li>
                        ...
                        management systems, improve energy efficiency, and
        ...
        <div
          ...
          className="max-w-7xl mx-auto bg-gray-100 py-2 px-6"
        >
