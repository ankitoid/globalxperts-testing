...
const ProfessionalServices = () => {
  ...
  const professionalVideoJsonLd = {
    ...
    embedUrl: "https://www.globalxperts.net/service/Professional-Services",
  };
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          property="og:video"
          content="https://main-website-images1.s3.ap-south-1.amazonaws.com/Main-Videos/Professional.mp4"
        />
        <meta
          property="og:video"
          content="https://main-website-images1.s3.ap-south-1.amazonaws.com/Main-Videos/ProfessionalF.mp4"
        />
        <script type="application/ld+json">
          {JSON.stringify(professionalVideoJsonLd)}
        </script>
        <script type="application/ld+json">
          {JSON.stringify(professionalFesVideoJsonLd)}
        </script>
          <link rel="canonical" href="https://globalxperts.net/service/professional-services" />
        ...
        <div className="max-w-7xl mx-auto py-20 lg:h-[70vh] 2xl:h-[50vh]">
          <div className="h-auto  flex flex-col items-center lg:flex-row justify-betweenpx-6 lg:px-16">
            <div className="w-full  text-center lg:text-left order-2 lg:order-1">
              <h1 className="text-3xl sm:mt-20 lg:text-4xl font-bold text-white mt-10 lg:mt-20 2xl:mt-20">
      ...
      <div className="md:bg-gray-100 lg:bg-white ">
        <div className="md:bg-gray-100 md:p-4 lg:bg-white grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-12 mb-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            ...
            <Link
              to="/service/professional-services/consulting-advisory"
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            ...
            <Link
              to="/service/professional-services/cloud-migration"
              className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center mt-auto"
            >
              More <span className="ml-2">&rarr;</span>
            </Link>
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            ...
            <Link
              to="/service/professional-services/implementation"
              className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center mt-auto"
            >
              More <span className="ml-2">&rarr;</span>
            </Link>
          ...
          <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-6 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px]">
            ...
            <Link
              to="/service/professional-services/staff-augmentation"
              className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center mt-auto"
            >
              More <span className="ml-2">&rarr;</span>
            </Link>
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-center  p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 ">
            ...
            <div className="bg-white 2xl:bg-gray-100 shadow-2xl p-8 hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between min-h-[450px] md:min-w-[350px]">
              ...
              <Link
                to="/service/professional-services/data-center-migration"
                className="text-blue-700 text-sm font-medium hover:underline flex items-center justify-center mt-auto"
              >
