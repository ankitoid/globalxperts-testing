  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="GlobalXperts OPSIS Live Streaming solution on AWS offers high-performance, scalable live video broadcast for events, corporate & media workflows across the USA." />
        <meta name="keywords" content="Live streaming, aws , secure "/>
          <link rel="canonical" href="https://globalxperts.net/solutions/aws-solutions/opsis-live-streaming" />
