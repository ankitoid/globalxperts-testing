...
const Financial = () => {
  ...
  return (
    <>
    <Helmet>
      <title>IT Solutions for Financial Services in USA - GlobalXperts</title>
      <meta name="description" content="GlobalXperts delivers IT solutions for financial services: secure, compliant infrastructure and cloud services tailored for banks, wealth firms and insurers." />
    </Helmet>
      <div className="w-full">
        ...
        <div className="bg-white">
          ...
          {/* Contact Section */}
          <div className="bg-white py-12 p-2">
