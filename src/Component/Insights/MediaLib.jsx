...
const MediaLib = () => {
  ...
  return (
    <>
      {/* SEO Metadata */}
      <Helmet>
        <title>Media Library - GlobalXperts</title>
        <meta
          name="description"
          content="Download GlobalXperts Brochure PDFs and explore our Media Library featuring IT solution guides, videos, and expert insights for digital transformation. "
        />
        <meta
          name="keywords"
          content="GlobalXperts brochures, Field Services PDF, Cybersecurity PDF, IT brochures, Contact Center Solutions, Titan GX storage, GX Customer Connect"
        />
        <meta property="og:title" content="Media Library | GlobalXperts" />
        <meta
          property="og:description"
          content="Explore and download brochures on GlobalXperts services including cybersecurity, cloud, field services, and more."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://www.globalxperts.net/media-library"
        />
        <meta
          property="og:image"
          content="https://main-website-brochures1.s3.ap-south-1.amazonaws.com/preview-image.jpg"
        />
          <link rel="canonical" href="https://globalxperts.net/insights/media-Library" />
      ...
      <section className="max-w-6xl mx-auto p-4">
        <h2 className="text-center text-2xl font-bold mt-8">Brochure PDFs</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {brochures.map((brochure, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-medium mt-4">{brochure.title}</h3>
            </a>
          ))}
        </div>
      </section>
      ...
      {/* Contact Us Section */}
      <div ref={contactRef} className="mt-12 p-4">
        <ContactCard />
      </div>
