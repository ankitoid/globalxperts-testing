...
const Partners = () => {
  return (
    <>
    <Helmet>
      <title>Our Partners - GlobalXperts </title>
      <meta name="description" content="Explore GlobalXperts’ U.S. partner ecosystem: trusted alliances with top cloud and IT vendors delivering managed services and seamless technology solutions. " />
        <link rel="canonical" href="https://globalxperts.net/insights/partners" />
